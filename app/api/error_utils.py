...
def map_provider_error(exc: httpx.HTTPStatusError, provider_label: str = "Search provider") -> HTTPException:
...
def map_network_error(exc: httpx.HTTPError, provider_label: str = "Search provider") -> HTTPException:
...
def map_provider_data_error(provider_label: str = "Search provider") -> HTTPException:
